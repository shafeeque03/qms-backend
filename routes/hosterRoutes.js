...
import { hosterLogin,createAdmin,getAllAdmins, getAdminDetails, changeAdminPassword,blockAndUnblockAdmin,verifyHosterOtp,resendOtp, VerifyAdmin } from '../controller/hosterController.js';
...
hosterRoute.post('/verifyAdmin',VerifyAdmin);
